...
PICS = (environ.get('PICS', 'https://telegra.ph/file/7b255dad94a8ba2e98391.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/b6c29a6e92e742de83140.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://te.legra.ph/file/6f55d902f9bf2d0afd4bb.mp4")
SPELL_IMG = environ.get("SPELL_IMG", "https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg")

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5651594253 2125405396 5611119015').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002089669369').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://paid:bot@cluster0.w2x7q.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
VERIFY = bool(environ.get('VERIFY', True))
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', "https://t.me/akmoviefile0/18")
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'vipurl.in')
SHORTLINK_API = environ.get('SHORTLINK_API', 'bdc457ac96b1d0b195933a63a158926bd28e59e3')
