...
F2LINK_C = environ.get("F2LINK_C", "-1001843498488")
ON_DWNLD = environ.get("ON_DWNLD", "cvccx-bbcc64327588.herokuapp.com")
ON_WATCH = environ.get("ON_WATCH", "cvccx-bbcc64327588.herokuapp.com")
